...
function App() {
  ...
  return (
    <div className="w-screen md:h-screen bg-regal-blue flex flex-col items-center justify-center relative overfloww-y-auto overflow-x-hidden">
      ...
      <div className="w-full flex-1 mt-10 md:mt-40 mb-8 px-2 md:px-20 md:mb-0 md:pl-20">
        ...
        <div className="flex md:w-1/2 items-center justify-center">
            <button className="bg-orange-400 hover:bg-orange-100 text-white font-bold py-6 px-12 rounded inline-flex items-center justify-center">
              <svg className="fill-current w-16 h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z" />
              </svg>
              <span className="text-white font-bold text-4xl md:text-6xl md:px-12 py-1 md:py-5">Download</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row w-full bg-regal-blue md:right-0 items-center justify-center">
        <div className="flex w-1/2 flex-col md:flex-row space-y-3 md:space-y-0 items-center justify-center md:justify-around px-4">
          <div className="flex flex-col items-center">
            <img className="w-3/12 md:w-1/6 h-auto rounded-full" src={card1} alt="Logo" />
            <button className="bg-opacity-0 bg-gray-300 text-orange-800 font-bold py-2 px-4
                  rounded-full inline-flex items-center justify-center">
              <span className="italic text-4xl md:text-5xl text-orange-400 hover:text-orange-200 px-1">Οδηγίες Χρήσης</span>
              </button>
          </div>
          <div className="flex flex-col items-center">
            <img className="w-3/12 md:w-1/6 h-auto rounded-full" src={card2} alt="Logo" />
            <button className="bg-opacity-0 bg-gray-300 text-orange-800 font-bold py-2 px-4
                rounded-full inline-flex items-center justify-center">
              <span className="italic text-4xl md:text-5xl text-orange-400 hover:text-orange-200  px-1">Απαντήσεις</span>
              </button>
          </div>
        </div>
